...
export default function Settings() {
	...
	const handleSubmit = () => {
		console.log(123);
		axios
			.put(`http://localhost:8800/api/users/${id}`, formData)
			.then((res) => res.data)
		...
		<>
			...
			<div className="containerMain">
				<div className="containerLeft">
					<div>
						<div className="leftRoutes activeRoute">
							Edit Profile
						</div>
						<div className="leftRoutes">Professional Account</div>
						<div className="leftRoutes">Change Password</div>
						<div className="leftRoutes">Apps and Websites</div>
						<div className="leftRoutes">Email and SMS</div>
						<div className="leftRoutes">Push Notifications</div>
						<div className="leftRoutes">Manage Contacts</div>
						<div className="leftRoutes">Privacy and Security</div>
						<div className="leftRoutes">Login Activity</div>
						<div className="leftRoutes">Emails from Instagram</div>
						<div className="leftRoutes">
							<Link to="/" className="linkSetting">
					...
					<div className="metaInfo">
						...
						<div className="moreAccountInfo ">
							<div>
								<Link
									to="/"
									className="linkSetting mt-8 mb-8 fs-16 "
								>
									Accounts Center
								</Link>
							</div>
				...
				<div className="containerRight">
					...
					<div className="flexmargin">
						...
						<div className="formValue">
							...
							<div className="moreInputInfo">
								...
								username back to {formData.username} for another
								14 days. Learn More
							</div>
						</div>
					</div>
					...
					<div className="flexmargin">
						<div className="formLabel">
							Similar Account Suggestion
						</div>
						<div className="formValue">
							<div className="checkboxDiv flex">
								<div className="checkboxAccSugg">
									<input
										type="checkbox"
										className="checkboxInput"
									/>
								</div>
								<div className="suggestcheckbox">
									Include your account when recommending
									similar accounts people might want to
									follow.
								</div>
							</div>
						</div>
